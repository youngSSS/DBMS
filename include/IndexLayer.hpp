...
int insert_into_page_after_splitting(int table_id, p_pnum old_pair, int left_index,
	int64_t key, pagenum_t right_pagenum);
int insert_into_parent(int table_id, pagenum_t parent_pagenum, pagenum_t left_pagenum, int64_t key,
...
int coalesce_nodes(int table_id, page_t* parent, p_pnum key_pair, p_pnum neighbor_pair,
	int neighbor_index, int k_prime);
int redistribute_nodes(int table_id, page_t* parent, p_pnum key_pair, p_pnum neighbor_pair,
