...
void print_usage() {
	printf(
		...
		"\tO <pathname> -- Open <pathname> file, <pathname> should be DATA1 ~ DATA10 format\n"
		"\tR <test_cnt> -- DB Recovery test\n"
		"\t             -- For each test, insert <flag> <log_num> <log_path> <logmsg_path>\n"
  		"\n"
		"\t-------------------- Modification -------------------\n"
		"\ti <table_id> <key> <value> -- Insert <key> <value> to table <table_id>\n"
		"\tf <table_id> <key> -- Find the value under <key> in table <table_id>\n"
		"\td <table_id> <key> -- Delete key <key> in table <table_id>\n"
		"\tI <table_id> <num1> <num2> -- Insert <num1> ~ <num2> to table <table_id>\n"
		"\tD <table_id> <num1> <num2> -- Delete <num1> ~ <num2> in table <table_id>\n"
  		"\n"
  		"\t-------------------- Transaction --------------------\n"
